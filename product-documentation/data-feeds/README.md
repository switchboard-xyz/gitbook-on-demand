...
Choose your blockchain ecosystem to get started with Switchboard oracle integration:

### **Current Ecosystems**

- **[Solana](solana/)** - Oracle Quotes with Ed25519 signature verification (90% cost reduction)
- **[EVM](evm/)** - Production-ready price consumer contracts for EVM-compatible chains
- **[Sui](sui/)** - Quote Verifier pattern with Move smart contracts
- **[Aptos](aptos.md)** - Native oracle integration for Aptos Move
- **[Iota](iota.md)** - Decentralized oracle data for IOTA ecosystem

### **Legacy Documentation**

For reference and migration purposes, previous documentation versions are available:

- **[Legacy Documentation](legacy/)** - Previous versions of ecosystem guides and tutorials
...
* **[Optional Features](legacy/optional-features/)** - Instructions and code examples to use optional features with Switchboard Feeds

---

**Ready to get started?** Choose your ecosystem above or explore our [complete examples repository](https://github.com/switchboard-xyz/sb-on-demand-examples) for hands-on integration guides.
