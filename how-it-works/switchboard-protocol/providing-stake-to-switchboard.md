...
The amount to distribute is governed by the Switchboard DAO through [svSWTCH governance](../../switchboard-protocol/governance-and-tokenomics.md), with the initial year set to distribute 8% of supply to stakers.
...
For complete details on tokenomics and reward distribution, see the [SWTCH Token Overview](../../switchboard-protocol/swtch-token-overview.md) and [Governance & Tokenomics](../../switchboard-protocol/governance-and-tokenomics.md) guides.
