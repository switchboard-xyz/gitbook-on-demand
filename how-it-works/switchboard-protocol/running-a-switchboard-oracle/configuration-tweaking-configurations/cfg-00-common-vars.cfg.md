...
If you don't have a DNS record, fear not, as explained in section [broken-reference](../../../../switchboard-protocol/running-a-switchboard-oracle/configuration-tweaking-configurations/broken-reference/ "mention") you can just leave it as it is written now and it will automatically resolve to your DNS.
