...
Once subscribed, prices are streamed to your application off-chain via WebSocket. You then convert and post these prices to your EVM chain of choice when needed for on-chain operations.
