# Switchboard Oracle Quote Verifier for Sui

## Overview

This guide demonstrates how to integrate Switchboard's on-demand oracle data into your Sui Move contracts using the **Quote Verifier** pattern. The Quote Verifier provides a secure, production-ready way to consume real-time price data with built-in validation and security features.
